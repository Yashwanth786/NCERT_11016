...
By Baye's theorem, 
\begin{align} 
\Pr(Y=1 / Z=0) &= \frac{\Pr((Z=0) . (Y=1))}{\Pr((Z=0) .( Y=1)) + \Pr((Z=0) . (Y=0))}
\end{align}
Since $X_i$ and $Y$ are independent events
\begin{align}
\Pr(Y=1 / Z=0) &= \frac{\Pr(Z=0)p_Y(1)}{\Pr(Z=0)p_Y(1) + \Pr(Z=0)p_Y(0)}\\
             &= \frac{\brak{\frac{1}{6}} \brak{\frac{2}{3}}}{\brak{\frac{1}{6}} \brak{\frac{2}{3}} + \brak{\frac{1}{6}} \brak{\frac{1}{3}}}\\
&= \frac{\brak{\frac{2}{18}}}{\brak{\frac{3}{18}}}\\
&= \frac{2}{3}\\
&\approx 0.667
\end{align}
\end{document}
